...
function binh_luan_insert($ma_kh, $ma_hh, $noi_dung, $ngay_bl){
    $sql = "INSERT INTO binh_luan(ma_kh, ma_hh, noi_dung, ngay_bl) 
...
function binh_luan_update($ma_bl, $ma_kh, $ma_hh, $noi_dung, $ngay_bl){
    ...
    SET ma_kh='$ma_kh',ma_hh='$ma_hh',noi_dung='$noi_dung',ngay_bl='$ngay_bl' WHERE ma_bl='$ma_bl'";
...
function binh_luan_select_by_hang_hoa($ma_hh){
    ...
    JOIN hang_hoa h ON h.ma_hh=b.ma_hh WHERE b.ma_hh='$ma_hh' ORDER BY ngay_bl DESC";
    return pdo_query($sql, $ma_hh);
}
function count_binh_luan(){
    $coments = binh_luan_select_all();
